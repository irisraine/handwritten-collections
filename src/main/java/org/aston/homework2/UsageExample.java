...
public class UsageExample {
    public static void main(String[] args) {
        ...
        System.out.print("[Arraylist contents after add another collection] : ");
        System.out.println(myArrayList1.toString());
        ...
        System.out.print("[Arraylist contents after deleting] : ");
        System.out.println(myArrayList1.toString());
        ...
        System.out.print("[Arraylist contents after sorting] : ");
        System.out.println(myArrayList1.toString());
        System.out.println();
        ...
        System.out.print("[LinkedList contents after deleting] : ");
        System.out.println(myLinkedList1.toString());
        System.out.print("[LinkedList sort] : ");
        MyLinkedList.sort(myLinkedList1);
        System.out.print("[LinkedList contents after sorting] : ");
        System.out.println(myLinkedList1.toString());
    }
}
